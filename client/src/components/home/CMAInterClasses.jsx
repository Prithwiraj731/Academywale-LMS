...
const classes = [
  { name: 'CMA Inter Class 1', img: 'https://placehold.co/120x80?text=Class+1' },
  { name: 'CMA Inter Class 2', img: 'https://placehold.co/120x80?text=Class+2' },
  { name: 'CMA Inter Class 3', img: 'https://placehold.co/120x80?text=Class+3' },
  { name: 'CMA Inter Class 4', img: 'https://placehold.co/120x80?text=Class+4' },
];

export default function CMAInterClasses() {
  return (
    <section className="py-12 bg-gradient-to-r from-blue-50 via-white to-blue-100">
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl md:text-3xl font-bold text-blue-800 font-pacifico">CMA Inter Classes</h2>
