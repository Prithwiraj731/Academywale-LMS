      ...
      <div className="bg-gray-900 text-white text-sm sm:text-base">
        <div className="max-w-7xl mx-auto px-4 py-1 flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <a href="https://wa.me/+919693320108" target="_blank" rel="noopener noreferrer" className="w-6 h-6 sm:w-7 sm:h-7 bg-green-500 rounded-full flex items-center justify-center hover:bg-green-600 transition">
