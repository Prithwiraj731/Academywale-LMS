...
export default function Navbar() {
  ...
  return (
    <div className="flex flex-col">
      <>
      {/* Top contact bar */}
      <div className="bg-gray-900 text-white text-sm sm:text-base w-full z-50">
        <div className="max-w-7xl mx-auto px-5 py-1 flex flex-col sm:flex-row justify-between items-center sm:items-center sm:justify-between">
          ...
          <div className="flex items-center space-x-6">
            <a href="https://wa.me/+919693320108" target="_blank" rel="noopener noreferrer" className="w-7 h-7 bg-green-500 rounded-full flex items-center justify-center hover:bg-green-600 transition">
            ...
            <a href="https://t.me/CMAspirants_01" target="_blank" rel="noopener noreferrer" className="w-7 h-7 bg-blue-500 rounded-full flex items-center justify-center hover:bg-blue-600 transition">
              <svg className="w-5 h-5" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://www.linkedin.com/in/sourav-pathak-30b385279?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" className="w-7 h-7 bg-blue-700 rounded-full flex items-center justify-center hover:bg-blue-800 transition">
