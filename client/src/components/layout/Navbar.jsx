  ...
  return (
    <>
      ...
      <div className="bg-gray-900 text-white text-sm sm:text-base">
        <div className="max-w-7xl mx-auto px-4 py-1 flex flex-col sm:flex-row justify-between items-center">
          <div className="flex items-center space-x-6 mb-1 sm:mb-0">
            ...
            <div className="flex items-center space-x-2">
              ...
              <span>support@facultywala.com</span>
            </div>
          </div>
          <div className="flex items-center space-x-4">
            <a href="https://chat.whatsapp.com/HmUSCs1IguT7Tew1z82JwO" target="_blank" rel="noopener noreferrer" className="w-6 h-6 sm:w-7 sm:h-7 bg-green-500 rounded-full flex items-center justify-center hover:bg-green-600 transition">
              <svg className="w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://t.me/CMAspirants_01" target="_blank" rel="noopener noreferrer" className="w-6 h-6 sm:w-7 sm:h-7 bg-blue-500 rounded-full flex items-center justify-center hover:bg-blue-600 transition">
              <svg className="w-4 h-4 sm:w-5 sm:h-5" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="https://www.linkedin.com/in/sourav-pathak-30b385279?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" className="w-6 h-6 sm:w-7 sm:h-7 bg-blue-700 rounded-full flex items-center justify-center hover:bg-blue-800 transition">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 sm:w-5 sm:h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
