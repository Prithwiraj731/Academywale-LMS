        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center space-x-3 mb-6">
              ...
              <span className="text-2xl font-heading font-bold">Academywale</span>
            </div>
            <p className="text-gray-300 mb-6 leading-relaxed">
              Academywale is India's most reliable platform for CA, CMA, and CS students to access high-quality exam preparation resources. 
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition">Our Faculties</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition">Associated Institutes</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition">Free Resources</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition">Terms & Conditions</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition">Refund & Cancellation</a></li>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-300">8910416751</span>
              </div>
              <div className="flex items-center space-x-3">
                <svg className="w-5 h-5 text-blue-400 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
