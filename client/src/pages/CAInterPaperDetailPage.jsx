...
const CAInterPaperDetailPage = () => {
  ...
  useEffect(() => {
    async function fetchCourses() {
      ...
      setError('');
      try {
        console.log(`Fetching CA intermediate courses from: ${API_URL}/api/courses/CA/intermediate/${paperId}`);
        
        // Define all the URL variations we'll try
        const urlVariations = [
          `${API_URL}/api/courses/CA/intermediate/${paperId}?includeStandalone=true`,
          `${API_URL}/api/courses/ca/intermediate/${paperId}?includeStandalone=true`,
