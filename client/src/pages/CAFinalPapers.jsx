            ...
            <div className="space-y-4">
              {group1.map(paper => (
                <Link
                  ...
                  className="group/btn relative w-full py-4 px-5 rounded-2xl bg-neutral-950 hover:bg-neutral-900/60 border border-neutral-855 hover:border-[#20b2aa]/40 text-left flex items-center justify-between shadow-md transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[#20b2aa]/5 gap-4"
                >
