            ...
            <div className="space-y-4">
              {group1.map(paper => (
                <Link
                  ...
                  className="group/btn relative w-full py-4 px-5 rounded-2xl bg-slate-50 hover:bg-slate-100 dark:bg-neutral-950 dark:hover:bg-neutral-900/60 border border-slate-200 dark:border-neutral-855 hover:border-[#20b2aa]/40 text-left flex items-center justify-between shadow-md transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[#20b2aa]/5 gap-4"
                >
