  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#e0f7f4] via-purple-50 to-yellow-50">
      ...
      <div className="container mx-auto px-4 py-8">
        {/* Header Section */}
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border border-[#20b2aa]">
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="text-right">
              <div className="text-2xl font-bold text-[#20b2aa]">{purchases.length}</div>
              <div className="text-gray-600">Courses Purchased</div>
            </div>
          </div>
        </div>
        ...
        {/* Courses Section */}
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-[#20b2aa]">
                  ...
                  {purchase.courseDetails.posterUrl && (
                    <div className="relative">
                      ...
                      <div className="absolute top-3 right-3">
                        <span className={`px-3 py-1 rounded-full text-xs font-semibold ${getStatusColor(purchase.isExpired, purchase.paymentStatus)} bg-white shadow-lg`}>
